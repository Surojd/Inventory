            ...
            <div class="container">
                <nav class="navbar navbar-default">
                    ...
                    <div class="navbar-header">
                        ...
                        <div class="logo">
                            <h1><a class="navbar-brand" href="">Inventory</a></h1>
                        </div>
                    </div>                   
                    ...
                    <form action="Login" method="post">
                        <div class="col-md-12 w3_agile_mail_grid">
                            <span class="input input--ichiro">
                                <input class="input__field input__field--ichiro" type="text" id="username" name="username" placeholder=" " required="">
                            ...
                            <span class="input input--ichiro">
                                <input class="input__field input__field--ichiro" type="password" id="password" name="password"placeholder=" " required="">
                ...
                <div class="w3ls_footer_grids">               
                    <div class="w3ls_footer_grid">
                        ...
                        <div class="col-md-4 w3ls_footer_grid_left">
                            ...
                            <div class="w3ls_footer_grid_leftr">
                                <h4>Email</h4>
                                <a href="mailto:surojsmiling@gmail.com">surojsmiling@gmail.com</a>
                            </div>
                            <div class="clearfix">
                            </div>
                        </div>
                        <div class="col-md-4 w3ls_footer_grid_left">
                            <a href="tel:+9779849199291">
                                <div class="w3ls_footer_grid_leftl">
                                    <i class="fa fa-phone" aria-hidden="true"></i>
                                </div>
                                <div class="w3ls_footer_grid_leftr">
                                    <h4>Call Me</h4>
                                    <p>(+977) 984 919 9291</p>
                                </div>
                            </a>
                            <div class="clearfix">
                            </div>
